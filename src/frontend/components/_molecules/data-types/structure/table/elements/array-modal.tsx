...
export const ArrayModal = ({
  ...
  const systemDataTypes = getSystemLibraryDataTypeNames(sliceLibraries.system, name)
  ...
  const VariableTypes = [
    ...
    { definition: 'user-data-type', values: mergeTypeNames(userDataTypes, systemDataTypes) },
  ]
